...
class ChampionshipsControllerTest < ActionController::TestCase
  ...
  test "should create championship" do
    assert_difference('Championship.count') do
      post :create, championship: { date: @championship.date, type_championship_id: @championship.type_championship_id }
    end
  ...
  test "should update championship" do
    patch :update, id: @championship, championship: { date: @championship.date, type_championship_id: @championship.type_championship_id }
    assert_redirected_to championship_path(assigns(:championship))
  end
